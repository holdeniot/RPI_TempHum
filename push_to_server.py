...
def push_data_minute(guid,temp,hum):

    url = urllib.request.urlopen("http://holdeniot.000webhostapp.com/rpi_uploads/temperatureMinute.php/?temp={0:0.01f}&hum={1:0.01f}&guid={2:1f}&page=0".format(temp,hum,guid))
